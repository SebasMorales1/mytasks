<div>
  <form wire:submit="signIn" class="border border-gray-700 mt-10 py-6 px-2 rounded shadow-md relative">
    @if(session('response'))
      <div class="text-red-100 bg-red-400 text-xs font-semibold px-1 py-2 mb-4 rounded">
        {{ session('response') }}
      </div>
    @endif
